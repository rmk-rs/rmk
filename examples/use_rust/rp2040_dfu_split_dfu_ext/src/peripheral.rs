...
async fn main(_spawner: Spawner) {
    ...
    let (row_pins, col_pins) = config_matrix_pins_rp!(peripherals: p, input: [PIN_8, PIN_9], output: [PIN_12]);
    ...
    // central forwards new firmware over the split link into the internal
    // DFU partition.
