...
- Keep the storage region intact when a startup read fails, instead of erasing it and rebooting; the startup scan also skips an item whose value does not decode instead of aborting
