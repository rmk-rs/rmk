...
mod tests {
    ...
    fn every_advertisement_fits_the_legacy_budget() {
        ...
        // The DFU name shares the host layout, so the same 16-byte budget
        // applies — longer custom names are truncated before advertising.
        assert!(!fits(Adv::DfuPeripheral {
