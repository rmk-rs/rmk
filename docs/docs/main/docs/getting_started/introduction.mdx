...
RMK is a high-performance and feature-rich keyboard firmware framework, designed for flexibility and ease of customization. RMK leverages the power of Rust and its great async [Embassy](https://embassy.dev/) ecosystem, providing comprehensive and modern functionality across a wide range of microcontrollers.
