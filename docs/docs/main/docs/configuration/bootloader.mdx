...
See [Split peripheral updates](../user_guide/flash_firmware/use_embassy_boot.mdx#split-peripheral-updates-dfu_split) for the update flow, the passthrough path and the peripheral firmware requirements.
