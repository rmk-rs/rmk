...
enabled = true
# Number of flash sectors to allocate. Defaults to 8 when the resolved config contains a [dfu]
# table (the chip defaults for nRF52840, nice!nano, RP2040 and Pico W ship one), otherwise 2
# unless your chip's default config sets a value
num_sectors = 2
